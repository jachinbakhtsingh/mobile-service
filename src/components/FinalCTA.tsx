    ...
    >
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 text-center flex flex-col items-center">
        ...
        <div
          ...
          className="relative my-8 sm:my-10 w-full max-w-[280px] xs:max-w-[320px] sm:max-w-[440px] md:max-w-[540px] lg:max-w-[620px] aspect-[16/9] flex items-center justify-center select-none"
        >
